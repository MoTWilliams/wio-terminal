# Button LED and Buzzer Sequence Generator — Wio Terminal
...
1. Select the Wio Terminal board.
1. Connect the Wio Terminal.
1. Upload the sketch to the device.
1. Open the Serial monitor at 115200 baud to view debug output.
...
1. The next sequence value is printed to the Serial monitor.
1. The LED blinks according to the generated value.

When Button C is pressed:

1. Both sequences reset to their starting values.
1. A reset message is printed to the Serial monitor.
